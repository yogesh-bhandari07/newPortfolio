...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} id='contact' className="bg-gray-900 w-full px-10 py-10 rounded-md font-outfit flex flex-col items-center justify-center">
      ...
      <button type='submit' disabled={state.submitting} class="relative inline-flex items-center justify-center px-4 py-2 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-orange-500 rounded-md shadow-md group">
        ...
        <span class="absolute flex items-center justify-center w-full h-full text-orange-500 transition-all duration-300 transform group-hover:translate-x-full ease">{state.submitting ? 'Submitting...' : 'Submit'}</span>
